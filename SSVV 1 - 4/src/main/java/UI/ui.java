...
public class ui {
    ...
    public static StudentValidator vs;
    public static TemaLabValidator vt;
    public static NotaValidator vn;
    ...
    */
    ...
    public void addNota() throws ValidatorException {
        Scanner scanner = new Scanner(System.in);
        String id,ids,idt,val,data, dw, dd;
        //scanner.nextLine();
        System.out.println("Id student:");
        ...
        //scanner.nextLine();
        System.out.println("delivered week:");
        dw=scanner.nextLine();
        //scanner.nextLine();
        ...
        String[] params={idt,ids,dw,dd, data, val1};
        try{
            notaSrv.add(params);
        }catch (ValidatorException ex){
            System.out.println(ex.getMessage());
